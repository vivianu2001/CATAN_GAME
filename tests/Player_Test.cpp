...
TEST_CASE("Trade resources between players")
{
    ...
    // CHECK(players[0].getResourceCount(ResourceType::Wood) == 5);
    // CHECK(players[1].getResourceCount(ResourceType::Brick) == 5);
...
//     player[1].addDevelopmentCard(DevelopmentCardType::Monopoly);
